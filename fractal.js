...
// Project config
fractal.set('project.title', 'EMA Style Guide');
fractal.set('project.url', 'https://ec-europa.github.io/ema-styleguide/');
fractal.set('project.repo', 'https://github.com/ec-europa/ema-styleguide');
